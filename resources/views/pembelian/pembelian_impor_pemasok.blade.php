...
<!-- Mirrored from www.kodingwife.com/demos/unipro/v1-x/05-design-violet/forms-dropzone.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 May 2023 03:02:32 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="overflow: hidden">
								...
								<div class="card">
									<div class="card-header">
										<div class="card-title">Impor Pemasok</div>
									</div>
									<div class="card-body">
												...
												<div id="dropzone">
													<form action="https://www.kodingwife.com/upload" class="dropzone needsclick dz-clickable" id="demo-upload">
														...
														<div class="dz-message needsclick">
															<button type="button" class="dz-button">Seret berkas di sini untuk mengunggah.</button><br>
														</div>

													</form>
													<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-left: 85%; margin-top:2%">
                                                        <a href="#" style="margin-right: 2%">Batal</a>
                                                        <button class="btn btn-primary" style="border-radius: 20px">Upload</button>
                                                    </div>
												</div>
