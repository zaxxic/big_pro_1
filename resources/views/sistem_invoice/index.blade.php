                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-title"><h3>Faktur</h3></div>
                                    ...
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="field-wrapper">
                                                ...
                                                <div class="field-placeholder" >Prefiks Nomor <span
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="field-wrapper">
                                                <div class="form-group">
                                                    <div class="field-placeholder" >Digit Nomor <span
                                                        class="text-danger">*</span></div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="field-wrapper">
                                                ...
                                                <div class="field-placeholder" >Nomor Berikutnya<span
                                                        class="text-danger">*</span></div>
                                                <div class="form-text">
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
												...
												<!-- Field wrapper start -->
												<div class="field-wrapper">
													<input class="form-control" type="text" placeholder="Masukan Judul">
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
												...
												<!-- Field wrapper start -->
												<div class="field-wrapper">
													<input class="form-control" type="text" placeholder="Masukan SubJudul">
