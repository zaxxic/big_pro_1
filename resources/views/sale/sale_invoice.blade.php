                            ...
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                    <div class="hidden-menu"
                                        ...
                                        &emsp;<a href="#" title="Batal"> <i class="icon-x-circle"
                                                style="color:#424242 "></i> </a>
                                        &emsp;<a href="#" title="Tandai Telah dikirim"> <i class="icon-send1"
                                                style="color:#424242 "></i> </a>
                                    ...
                                    <table class="table table-hover caption-top">
                                        <thead>
                                            <tr>
                                                <th scope="col"> <input type="checkbox" id="select-all-checkbox">
                                                </th>
