						    ...
						    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"><h3>Faktur<button type="button" style="border: none; background:transparent;">☆</button></h3></div>
									...
									<nav class="d-flex">
										...
										{{-- <ul class="d-flex" style="font-size: 13pt; margin-top: 5%"> --}}
										  <h6 class="empty-box text active" style="margin-right: 20%"><a href="{{ url ('invoice')}}" >Faktur</a></h6>
										</div>
										<div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-6" style="margin-top: 8%;">
										  <h6 class="empty-box text" style="margin-left:-20%; margin-right:40%" ><a href="{{ url ('recurring_invoice')}}">Faktur Berulang</a></h6>
										</div>
										{{-- </ul> --}}
									  </nav>
                                        <div class="content">
