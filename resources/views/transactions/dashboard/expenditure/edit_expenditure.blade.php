                                    ...
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="field-wrapper-group">
                                                ...
                                                <button type="button" class="input-icon-block btn btn-info" data-bs-toggle="modal" data-bs-target="#modalaccount">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="field-wrapper-group">
                                                ...
                                                <button type="button" class="input-icon-block btn btn-info" data-bs-toggle="modal" data-bs-target="#modalcategory">
                                                    <i class="icon-plus1"></i>
                                                </button>
                                            </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="field-wrapper-group">
                                                ...
                                                <button type="button" class="input-icon-block btn btn-info" data-bs-toggle="modal" data-bs-target="#modalsupplier">
                                                    <i class="icon-plus1"></i>
                                                </button>
                                            </div>
