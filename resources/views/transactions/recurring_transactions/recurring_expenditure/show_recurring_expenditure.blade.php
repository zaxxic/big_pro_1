                                ...
                                <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-12">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg-end" style="z-index: 100;">
                                            <li><a class="dropdown-item" style="margin-top: 4%;" href="{{url('add_recurring_expenditure')}}">Tambah</a></li>
                                            <li><a class="dropdown-item" href="{{url('add_recurring_expenditure')}}">Sunting</a></li>
