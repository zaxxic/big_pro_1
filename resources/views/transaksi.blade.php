                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="col-xl-5 col-lg-5 col-md-2 col-sm-2 col-12 d-flex ms-auto button-container">
                                        <button href="{{url('add_pendapatan')}}" id="income-button" type="button" class="btn btn-secondary">Tambah Pendapatan</button>

                                        <button href="" id="expense-button" type="button" class="btn btn-secondary">Tambah Pengeluaran</button>

                                        <!-- <div class="col-xl-1 col-lg-1 col-md-2 col-sm-2 col-12">
                                            <button href id="export-button" type="button" class="btn btn-outline-primary">Ekspor</button>
                                        </div> -->
