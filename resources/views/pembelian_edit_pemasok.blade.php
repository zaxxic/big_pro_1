									...
									<div class="card-body">
										...
										<div class="row gutters">
											...
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												...
												<!-- Field wrapper start -->
												<div class="field-wrapper">
													<input class="form-control" type="text" placeholder="Nomor pajak muncul di setiap faktur yang diterbitkan kepada pelanggan. Mata uang yang dipilih menjadi mata uang default untuk pelanggan ini.">
